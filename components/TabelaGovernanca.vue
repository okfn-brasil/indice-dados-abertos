...
<template>
  ...
  <div class="conjunto-banner" v-if="!current.score">
    <div class="container-fluid wrap text-center">
      ...
      <div class="btn-tooltip big mt-0 cursor-pointer"><NuxtLink to="/#metodologia">Saiba mais na nota metodológica</NuxtLink></div>
    </div>
  </div>
      ...
      <div class="tooltip" v-if="tooltip" :style="{left: tipPos.x+'px', top: tipPos.y+'px'}">
        ...
        <template v-else-if="tooltip.capital">
          ...
          <template v-if="tooltip.ranking">
            ...
            <p class="label" :class="escalaGlobal(tooltip.capital[current.key])">{{tooltip.capital[current.key]}}</p>
          </template>
          ...
          <table class="tabela tabela-conjunto-dados">
            ...
            <tbody>
              <tr v-for="(c, index) in Object.values(capitais).sort((a,b)=>{return b.notas[current.key]-a.notas[current.key]})">
                ...
                <td v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }" class="nivel"><span class="label" :class="escalaGlobal(c.notas[current.key])">{{escalaGlobal(c.notas[current.key])}}</span></td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g1'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g2'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g3'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g4'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g5'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g6'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g7'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g8'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g9'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
                <td class="indicador" :class="escalaForm(c.entradas[current.key]['g10'])" v-on="{ mouseenter: (e)=>{tip(e,{capital:c,ranking:index})}, mousemove:tipM, mouseleave: ()=>{tip(false)}, click:()=>{navigateTo('/capital/'+c.slug)} }">&nbsp;</td>
              </tr>
            </tbody>
          </table>
        </div>
